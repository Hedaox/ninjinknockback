...
public class EnergyKnockback {
    ...
    // Can be used by other mods to prevent user to do energy knockback
    public static Set<UUID> playerListCantUseEnergyKnockback = new HashSet<>();
    ...
    public void updateEventOnPlayerTick(PlayerTickEvent event) {
        ...
        if (!event.player.worldObj.isRemote) {
            ...
            if (KiChargingPlayerMap.get(event.player.getUniqueID()) != null && !(playerListCantUseEnergyKnockback.contains(event.player.getUniqueID()))) {
